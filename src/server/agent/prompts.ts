...
1. WHAT DID I DO THIS WEEK — Every customer meeting in the last 7 days: account, date, type, 1–2 sentence summary, key decisions.
2. WHAT AM I PLANNING TO DO NEXT WEEK — All open action items owned by the SA grouped by account, sorted by due date. Flag anything due within 7 days.
3. DO I HAVE THE TECH WIN — Per account: ✅ Tech Win / ⚠️ In Progress / ❌ Not Yet. Justify with one sentence from the data (sentiment, decisions_made, sales_stage, open blockers).
